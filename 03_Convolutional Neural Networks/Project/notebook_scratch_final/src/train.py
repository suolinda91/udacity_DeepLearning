...
def train_one_epoch(train_dataloader, model, optimizer, loss):
    ...
    for batch_idx, (data, target) in tqdm(
        ...
        # 1. clear the gradients of all optimized variables - DONE
        optimizer.zero_grad()
        # 2. forward pass: compute predicted outputs by passing inputs to the model - DONE
        output  = model(data)
        # 3. calculate the loss - DONE
        loss_value  = loss(output, target)
        # 4. backward pass: compute gradient of the loss with respect to model parameters - DONE
        # YOUR CODE HERE:
        loss_value.backward()
        # 5. perform a single optimization step (parameter update) - DONE
        # YOUR CODE HERE:
        optimizer.step()
...
def valid_one_epoch(valid_dataloader, model, loss):
    ...
    with torch.no_grad():
        ...
        # set the model to evaluation mode - DONE
        # YOUR CODE HERE
        model.eval()
        ...
        for batch_idx, (data, target) in tqdm(
            ...
            # 1. forward pass: compute predicted outputs by passing inputs to the model - DONE
            output  = model(data)
...
def one_epoch_test(test_dataloader, model, loss):
    ...
    with torch.no_grad():
        ...
        for batch_idx, (data, target) in tqdm(
            ...
            # HINT: the predicted class is the index of the max of the logits - DONE
