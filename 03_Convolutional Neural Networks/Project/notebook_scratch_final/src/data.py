    ...
    data_transforms = {
        "train": transforms.Compose(
            [
                ...
                # Lastly, take a 224x224 part of the image
                transforms.RandomCrop(224),
                # Horizontal flip of the image with a 50% probability
                transforms.RandomHorizontalFlip(0.5),
                # Additional augmentations
                transforms.RandAugment(num_ops=2,
                                       magnitude= 12,
                                       interpolation=transforms.InterpolationMode.BILINEAR),
                # Colour modifications for brightness and saturation. These modifications are randomly applied
...
#                 ]),
        ...
        "valid": transforms.Compose(
            [
                # Resize to 256x256
                transforms.Resize(256),
                # Crop the central 224x224 part of the image
    ...
    train_data = datasets.ImageFolder(
        ...
        # YOUR CODE HERE: add the appropriate transform that you defined in - DONE
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    # YOUR CODE HERE:
    # Get class names from the train data loader - DONE
